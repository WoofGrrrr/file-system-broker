/*
 * This file is provided by the webext-support-filesystem-plus repository at
 * ???
 *
 * Author: WoofGrrrr
 *
 ...
 *
 * - Uses a supplied Extension ID instead of *this* extension's ID
 *
 * - New functions:
 *   . exists
 *   . isRegulerFile
    ...
    return {
      ...
      BrokerFileSystem: {
        ...
        async isDirectory(extensionId, directoryName) {
          ...
          if (directoryName && ! checkFileName(directoryName)) { // directoryName is optional
        ...
        async getFileInfo(extensionId, fileName) {
          if (! checkFileName(extensionId)) { // if fileName were optional could get FileInfo for the extensionID directory
